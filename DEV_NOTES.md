...
Every communication between Nodes and Hub is visible and if something goes wrong an error is surfaced. There should not be one-off requests that fail silently.
